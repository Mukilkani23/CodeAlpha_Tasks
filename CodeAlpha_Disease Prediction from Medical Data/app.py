...
model = XGBClassifier()
model.load_model('heart_disease_model.json')
...
with col3:
    ...
    thal = st.selectbox("Thalassemia", options=[0, 1, 2, 3],
                        format_func=lambda x: ["Unknown", "Normal",
                                                "Fixed Defect", "Reversible Defect"][x])
...
if st.button("Predict"):
    ...
    probability = model.predict_proba(input_data, validate_features=False)[0][1]
